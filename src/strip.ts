...
export type ContentBlock = { type: string };
...
// for stripping.
export function findBoundary(messages: Message[]): number {
...
export function stripBeforeBoundary(messages: Message[], boundaryIndex: number): Message[] {
